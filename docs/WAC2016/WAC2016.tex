...
\section{Interfaces}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item Absolute Category Rating (ACR) Scale
		\begin{itemize}
			\item 5 point Scale - Bad, Poor, Fair, Good, Excellent (Default fair?)
		\end{itemize}
		\item Degredation Category Rating (DCR) Scale
		\begin{itemize}
		...
		\end{itemize}
		\item Comparison Category Rating (CCR) Scale
		\begin{itemize}
		...
		\end{itemize}
		\item 9 Point Hedonic Category Rating Scale
		\begin{itemize}
		...
		\end{itemize}
		\item ITU-R 5 Point Continuous Impairment Scale
		\begin{itemize}
		...
		\end{itemize}
		\item Pairwise Comparison (Better/Worse)
		\begin{itemize}
