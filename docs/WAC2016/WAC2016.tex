...
\section{Introduction}
    ...
    \begin{center}
    	\begin{tabular}{|*{5}{l|}}
			...
			(Semantic differential)								& 						&	\checkmark				& (\checkmark)		&				\\ % same as a few of the above
    		\hline
    	\end{tabular}
    \end{center}
...
\section{Analysis and diagnostics}
	...
	\begin{itemize}[noitemsep,nolistsep]
		...
		\item Timeline for a specific subject / song %(see Python scripts), perhaps re-playing the experiment in X times realtime. (If actual realtime, you could replay the audio...) ---> A LOT of work, not sure I can guarantee this one
